  ...
  <el-row>
    ...
    <el-row>
      ...
      <el-row v-if="welcomeScreen">
        <!--TODO-->
        <iframe src="https://101.qq.com/#/hero-rank-interest?tier=30" width="100%" height="900px"
                allowtransparency="true" frameborder="0"></iframe>
      </el-row>
      <!-- 组队中心 -->
      <el-row v-if="viewId === 'teamCenter'">
        <el-row>
          <el-table :data="tableData" ref="userTable" height="350" border style="width: 95%; margin: 2%"
                    v-if="viewId === 'teamCenter'" @selection-change="handleSelectionChange">
            <el-table-column
                type="selection"
                width="55">
            </el-table-column>
      ...
      <el-row v-if="viewId == 'voice'" class="voice">
        <iframe src="https://kookapp.cn/widget?id=4876588041648115&theme=dark" width="100%"
                height="700px" allowtransparency="true" frameborder="0"></iframe>
      </el-row>
    </el-row>
  </el-row>
</template>
...
export default {
  ...
  methods: {
    ...
    startMatch(){
      ...
      this.blueteam = [];
      this.redteam = [];
      const tempSortTeam = this.multipleSelection.sort((a,b) => {return a.rankLevel - b.rankLevel});
      this.blueteam.push(tempSortTeam[0],tempSortTeam[9],tempSortTeam[3],tempSortTeam[6],tempSortTeam[5]);
      this.redteam.push(tempSortTeam[1],tempSortTeam[8],tempSortTeam[2],tempSortTeam[7],tempSortTeam[4]);
